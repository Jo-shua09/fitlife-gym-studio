      ...
      <div className="w-full text-center flex justify-center flex-col gap-y-5">
        ...
        <div className="w-full flex items-center gap-x-16 gap-y-10 flex-wrap-reverse md:flex-nowrap mt-20">
          ...
          <div className="w-full max-w-4xl mx-auto overflow-hidden rounded-xl shadow-2xl">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387193.05057513894!2d-74.3091634187714!3d40.69719335572737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sng!4v1746302535839!5m2!1sen!2sng"
              width="100%"
              height="450"
              style={{ border: 0 }}
